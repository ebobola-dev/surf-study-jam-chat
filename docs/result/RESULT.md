 ...
 **[Дизайн](https://symu.co/freebies/mobile-apps/nearby-free-figma-mobile-app-template/)** для приложения был взят с сайта **[symu.co](https://symu.co/freebies/mobile-apps)**<br>
 ...
 Приложение отлаживал на реальном Andriod устройстве (Redmi note 8 pro), к сожалению, не имею возможности посмотреть как приложение выглядит на IPhone, так как нет макбука и никаких устройств Apple
 ...
 - Как отображается время сообщения:
	 ...
	 - Иначе: дата и время сообщения, "dd.MM.yyyy, HH:mm"
 ```dart
 ...
 - При отправке сообщения, а также обновлении списка сообщений, ListView автоматически прокручивается вниз (А конкретно, он прокручивается, только когда кол-во сообщений изменилось после обновления)
 ```dart
