...
:-------------------------:|:-------------------------:
Список чатов(топиков) можно обновить нажав на икноку в правом верхнем углу  |   Нажав на плюсик в левом верхнем углу, открывается диалоговое окно, в котором можно создать новый чат
...
:-------------------------:|:-------------------------:
Если в сообщении несколько картинок, то сверху справа у изображения будет бадж с количеством изображений  |  Когда в сообщении несколько изображений, можно нажать на фото, чтобы открыть диалоговое окно для просмотра всех прикрепленных изображений
